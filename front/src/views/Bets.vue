...
div#bet-slip
    ...
    div#bets-actions(v-if="showBlockBetsActions")
        ...
        p.buttons
            span(@click="$root.$emit('changeInfoViewStatus', false)"): img(src="@/assets/images/icons/hide.svg", :title="$t('hide.info.betSlips')")
            span(@click="$root.$emit('changeInfoViewStatus', true)"): img(src="@/assets/images/icons/show.svg", :title="$t('show.info.betSlips')")
...
import appBetSlip from "@/components/bet/BetSlip";
export default {
    name: "app-bets",
    components: {
        appBetSlip,
