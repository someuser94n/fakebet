...
describe("match/Selector.vue", () => {
  ...
  describe("Testing computed properties", () => {
    describe("show", () => {
      const makeIt = (propName, propValue, { emptySelectedMatches }) => {
    ...
    describe("matchesFromSelectedLeagues", () => {
      const makeIt = (type, direction, expected) => {
  ...
  describe("Testing methods", () => {
    it("sortMatches", () => {
      mountWrapper();
      const customSort = { name: "sortByName", direction: 11 };
