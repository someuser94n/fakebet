...
describe("Testing store/match", () => {
  ...
  describe("Testing getters", () => {
    it("matches", () => {
      ...
      const rootGetters = { "league/selectedLeagues": ["League 2"] };

      const matches = getters.matches(state, null, null, rootGetters);
    ...
    it("selectorItemMode", () => {
      ...
      const mode = getters.selectorItemMode(state);
  ...
  describe("Testing mutations", () => {
    ...
    it("cleanMatches", () => {
      ...
      const selectedLeagues = ["League 1"];
    ...
    it("pushMatches", () => {
      ...
      const matchData = [{ key: "match 2", date: 1546383600000 }, { key: "match 3", date: 1556383600000 }];
