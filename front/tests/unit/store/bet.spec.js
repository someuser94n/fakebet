...
describe("Testing store/bet", () => {
  ...
  describe("Testing getters", () => {
    ...
    it("waitingBets", () => {
      ...
      const waitingBets = getters.waitingBets(state);
    ...
    describe("filteredResultBets", () => {
      it("get all result bets", () => {
        ...
        const resultBets = getters.filteredResultBets(state);
    ...
    describe("filteredAndSortedResultBets", () => {
      it("sorted in descending mode", () => {
        ...
        const filteredResultBets = [{ key: 2 }, { key: 3 }, { key: 1 }];

        const resultBets = getters.filteredAndSortedResultBets(state, { filteredResultBets });
    ...
    it("selector", () => {
      ...
      const selector = getters.selector(state);
  ...
  describe("Testing mutations", () => {
    describe("changeCurrentBetSlip", () => {
      it("must push new betSlip", () => {
        ...
        const betData = mapProperties("key", "bookie", "type");
        const matchData = mapProperties("home", "guest", "date", "dateTmpl", "league");
      ...
      it("must remove existing betSlip", () => {
        ...
        const betData = mapProperties("key", "type");
